...
import static com.accessjobs.pjp.security.SecurityConstants.HEADER_STRING;
import static com.accessjobs.pjp.security.SecurityConstants.TOKEN_PREFIX;

//if the token ok , let the user access resources
    ...
    protected void doFilterInternal(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse,
        ...
        try {
            ...
            if(StringUtils.hasText(jwt)&& tokenProvider.validateToken(jwt)){
                ...
                logger.warn("Id in filter class is ------ : "+userId);
